...
public class LibroDAO {
    ...
    public static void printLibroDetails(){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error con imprimir detalles de los libros.");
    ...
    public static void printLibrosPrestados(){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error con imprimir la lista de libros prestados.");
            e.printStackTrace(); //Ens tornaria el trazo del error, ens diu quin error hi ha al SQL.
        }
    }
    ...
    //MÉTODO PARA RECIBIR TODOS LOS TITULOS DE LOS LIBROS
     public static List<String> getAllLibrosName(){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
           ...
           System.out.println("Error con obtener la lista de todos los libros.");
            e.printStackTrace();
        }
        return librosName;
    }
    ...
    public static void insertLibro(String titulo, String autor, boolean disponibilidad){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error con insertar un libro.");
            e.printStackTrace();
        }
    }
    ...
    public static void updateDispoLibro(boolean newDispo){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error con cambiar la disponibilidad del libro.");
            e.printStackTrace();
        }
    }
    ...
    public static void librosPrestados(boolean newDispo){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error con la impresión de libros prestados.");
            e.printStackTrace();
        }
    }
    ...
    public static void librosDevueltos(int id_Libro, boolean newDispo){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
           ...
           System.out.println("Error con la impresión de libros devueltos.");
            e.printStackTrace();
        }
    }
    ...
    //MÉTODO PARA BORRAR LIBRO
         ...
         public static void deleteLibro(int id, String titulo) { // Estos parámetros se utilizan para identificar el usuario que se va a eliminar de la base de datos.
    ...
    try (Connection conn = DatabaseConnection.getConnection(); // Creamos la conexión con la base de datos 
        ...
        System.out.println("Se ha borrado el libro " + titulo + ". Ya no está disponible. Lo lamentamos ");
    } catch (SQLException e) {
        e.printStackTrace();
    }
}
