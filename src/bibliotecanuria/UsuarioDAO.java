...
public class UsuarioDAO {
    ...
    public static void printUsuarioDetails(){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error con imprimir detalles del Usuario .");
    ...
    public static void insertUsuario(String nombre_Usuario, String rol){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("No se ha podido insertar el Usuario correctamente.");
            e.printStackTrace();
        }
    }
    ...
    public static void insertUsuarioLibroPrestado(int id_Usuario, String nombre_Usuario, int id_Libro, String titulo){
       ...
       public static boolean usuarioTieneLibroPrestado(String nombre_Usuario, String titulo) {
        String query = "SELECT * FROM Usuario_LibrosPrestados WHERE nombre_Usuario = ? AND titulo = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(query)) {
    ...
    public static void eliminarUsuarioLibroPrestado(String nombre_Usuario, String titulo) {
        String query = "DELETE FROM Usuario_LibrosPrestados WHERE nombre_Usuario = ? AND titulo = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(query)) {
            pstmt.setString(1, nombre_Usuario);
            pstmt.setString(2, titulo);
