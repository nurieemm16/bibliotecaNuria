...
public class Libro {
    ...
    /*Creo el constructor público para la clase Libro y le paso los argumentos (atributos) privados que he declarado anteriormente (ahora serán accesibles con el constructor)*/
        ...
        "listaLibrosGenerica", "listaLibrosDisponibles" y "listaLibrosNoDisponibles.*/
        ...
        public static List<String> getAllLibrosName(){
         ...
         public static void insertLibro(String titulo, String autor, boolean disponibilidad){
          ...
          public static void cambiarDisponibilidad(String titulo, boolean dispo){
            ...
            public static void deleteLibro(int id, String name){
            LibroDAO.deleteLibro(id, name);
        }
